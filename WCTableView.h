...
@protocol WCTableViewDataSource <NSObject>
@required
...
@protocol WCTableViewDelegate <NSObject>
@optional
...
@interface WCTableView : UITableView<UITableViewDataSource,UITableViewDelegate>
{
